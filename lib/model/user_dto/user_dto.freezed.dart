...
class _$_UserDto implements _UserDto {
  const _$_UserDto(this.status, this.data);
  ...
  @override
  String toString() {
    return 'UserDto(status: $status, data: $data)';
  }
...
abstract class _UserDto implements UserDto {
  const factory _UserDto(final String status, final Data data) = _$_UserDto;
...
class _$_Data implements _Data {
  const _$_Data(this.token, this.userDetail);
  ...
  @override
  String toString() {
    return 'Data(token: $token, userDetail: $userDetail)';
  }
...
abstract class _Data implements Data {
  const factory _Data(final String token, final UserDetail userDetail) =
      _$_Data;
