...
class _$_UploadBookRequest implements _UploadBookRequest {
  ...
  @override
  String toString() {
    return 'UploadBookRequest(title: $title, writer: $writer, subject: $subject, about: $about, pages: $pages, semister: $semister, bookEdition: $bookEdition, price: $price, tags: $tags, rating: $rating)';
  }
...
abstract class _UploadBookRequest implements UploadBookRequest {
  const factory _UploadBookRequest(
      ...
      final String? about,
      final int? pages,
      required final int semister,
      final int? bookEdition,
      final int? price,
      required final List<String> tags,
      final bool? rating}) = _$_UploadBookRequest;
